 ...
 */
 (function($){
	...
	$.extend($.PaginationRenderers.defaultRenderer.prototype, {
		...
		createPage:function(end, current_page, appendopts){
			var lnk, np = this.pc.numPages();
			lnk = $("<span>" + (current_page + 1) + "/" + end + "</span>");
			return lnk;
		},
...
//			}
			this.createPage(end, current_page, opts).appendTo(container);
		},
		getLinks:function(current_page, eventHandler) {
			var begin, end;
			var	interval = this.pc.getInterval(current_page);
